...
type
  ...
  public
    ...
    function UniformSingle( _offset, _range: Single ): Single;  overload; inline;
    ...
    function UniformDouble( _offset, _range: Double ): Double;  overload; inline;
    ...
    function UniformExtended( _offset, _range: Extended ): Extended;  overload; inline;
...
function TMT19937.UniformSingle( _offset, _range: Single ): Single;
begin
  Result := _range * NextSingle + _offset;
end;
...
begin
  if not FGaussSingle.IsNan then begin
    Result := FGaussSingle * _sigma + _mu;
    FGaussSingle := nan;
    exit;
  end;
  repeat
...
function TMT19937.UniformDouble( _offset, _range: Double ): Double;
begin
  Result := _range * NextDouble + _offset;
end;
...
begin
  if not FGaussDouble.IsNan then begin
    Result := FGaussDouble * _sigma + _mu;
    FGaussDouble := nan;
    exit;
  end;
  repeat
...
function TMT19937.UniformExtended( _offset, _range: Extended ): Extended;
begin
  Result := _range * NextExtended + _offset;
end;
...
begin
  if not FGaussExtended.IsNan then begin
    Result := FGaussExtended * _sigma + _mu;
    FGaussExtended := nan;
    exit;
  end;
  repeat
